...
import {getLaptopsViewedByUserId} from "../../store/actions/laptopAction";
...
export default function UserProfile() {
    ...
    const { laptopsViewed } = useSelector(state => state.laptop);
    const section = location.hash || '#profile'
    useEffect(() => {
    ...
    useEffect(() => {
        dispatch(getLaptopsViewedByUserId(id))
    }, [id]);

    const [formData, setFormData] = useState({
        fullname: "", phone: '', username: '', email: '', password: "", confirmPassword: "", dob: '',
    });
    ...
    const renderSection = () => {
        switch (section) {
            ...
            case '#view-history':
                return (
                    <div>
                        ...
                        <div className=" mt-8">
                            <div
                                className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 md:grid-cols-3 lg:grid-cols-5 xl:gap-x-8 me-2">
            ...
            default:
                return <p>Chào mừng đến với tài khoản GEARVN!</p>;
        }
    };
                ...
                <div className="mt-24 lg:grid lg:grid-cols-12 gap-x-4 flex flex-col-reverse mb-6">
                    <div className="lg:col-span-3 lg:mt-0 col-span-12 bg-white rounded-md shadow-md mt-6">
                        <div className="ms-4">
                            ...
                            {/*    <Link to={'#addresses'} className="flex items-center mb-6 hover:text-red-500 group"*/}
                            {/*    >*/}
                            {/*        <svg*/}
                            ...
                            {/*    <Link to={'#orders-tracking'} className="flex items-center mb-6 hover:text-red-500 group"*/}
                            {/*    >*/}
                            {/*        <svg*/}
                            {/*            className="h-5 w-5 fill-current text-black group-hover:text-red-500"*/}
                            {/*            viewBox="0 0 24 24"*/}
                            ...
                            {/*    <Link to={'#view-history'} className="flex items-center mb-6 hover:text-red-500 group"*/}
                            {/*    >*/}
